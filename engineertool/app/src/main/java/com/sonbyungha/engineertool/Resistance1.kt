...
class Resistance1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?){
        ...
        setContentView(R.layout.resistance_caculator_layout)

        edit1 = findViewById<EditText>(R.id.edit1)
        edit2 = findViewById<EditText>(R.id.edit2)
        btnserial = findViewById<Button>(R.id.serial_bt)
        btnparallel = findViewById<Button>(R.id.parallel)
        textResult = findViewById<TextView>(R.id.result)
    }

    fun serial(view: View)
    {
        num1 = edit1.text.toString()
        num2 = edit2.text.toString()
        result = num1.toDouble() + num2.toDouble()
        textResult.text ="직렬계산 결과(Ω): " +result.toString()
    ...
    fun parallel(view: View)
    {
        ...
        textResult.text= "병렬계산 결과(Ω) : " +result.toString()
